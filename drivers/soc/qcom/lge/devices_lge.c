...
#elif defined(CONFIG_MACH_SDM450_CV7A_LAO_COM) || defined(CONFIG_MACH_SDM450_CV7A_KR) || defined(CONFIG_MACH_SDM450_CV7A_LAO_COM_NONAB) || defined(CONFIG_MACH_SDM450_CV7A_LGU_LDR) || defined(CONFIG_MACH_SDM450_CV7A_JP)
...
char *rev_str[] = {"rev_a", "rev_a_2", "rev_a_3", "rev_b", "rev_c",
	"rev_10", "rev_11", "reserved"};
#elif defined(CONFIG_MACH_MSM8940_SF3_MPCS_US) || defined(CONFIG_MACH_MSM8940_SF3_TMO_US) || defined(CONFIG_MACH_MSM8940_TF8_TMO_US) || defined(CONFIG_MACH_MSM8940_SF3_GLOBAL_CA) || defined(CONFIG_MACH_MSM8917_CV1_LAO_COM) || defined(CONFIG_MACH_MSM8917_CV1_VZW) || defined(CONFIG_MACH_MSM8917_CV1_ATT_US) || defined(CONFIG_MACH_MSM8917_CV1_CRK_US) || defined(CONFIG_MACH_MSM8917_CV1_KDDI_JP)
